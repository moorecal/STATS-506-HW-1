...
#' @param integer 
#'
#' @returns the next number in the Collatz Conjecture sequence. Gives errors requesting numeric and integer inputs if the user attempts a non numeric. Rounds floats to nearest integer value smaller than it.
